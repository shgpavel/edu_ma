...
$ - \frac{\sin{\varphi}}{\rho} w''_{\varphi^2} \varphi'_x. $

$ u''_{y^{2}} = (\sin{\varphi} w'_{\rho} + \frac{\cos{\varphi}}{\rho} w'_{\varphi})'_y
 = -\cos{\varphi} \varphi'_y w'_{\rho} + \sin{\varphi} w''_{\rho^2} \rho'_y
 - \frac{\sin{\varphi}}{\rho} \varphi'_y w'_{\varphi}
 - \frac{\cos{\varphi}}{\rho^2} \rho'_y w'_{\varphi} $

$ + \frac{\cos{\varphi}}{\rho} w''_{\varphi^2} \varphi'_y. $
